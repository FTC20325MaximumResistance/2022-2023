...
public class manualDrive extends OpMode {
    ...
    public void loop() {
        ...
        if (!armMoving) {
            ...
            r.arm2.setPower(r.arm2.getCurrentPosition()  >4200 ? -gamepad2.right_stick_y < 0 ? -gamepad2.right_stick_y : 0 : r.touch4.isPressed() || r.arm2.getCurrentPosition() < 10 ? -gamepad2.right_stick_y > 0 ? -gamepad2.right_stick_y * deflator2 : 0 : -gamepad2.right_stick_y * deflator2);
        }
        ...
        */
        ...
        //*/
        if (r.getTolerance(r.arm2.getCurrentPosition(), r.arm2.getTargetPosition(),150) || gamepad2.left_trigger > 0.25){
            //r.arm1.setPower(0);
            r.arm2.setPower(0);
