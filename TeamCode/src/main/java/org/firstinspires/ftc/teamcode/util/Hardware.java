...
public class Hardware {
    ...
    public void initHardware() {
        ...
        try {
            backleftR = opMode.hardwareMap.get(DigitalChannel.class, "BackLefRt");
            backrightG = opMode.hardwareMap.get(DigitalChannel.class, "BackRightG");
            ...
            backleftG = opMode.hardwareMap.get(DigitalChannel.class, "BackLeftG");
            backrightR = opMode.hardwareMap.get(DigitalChannel.class, "BackRightR");
